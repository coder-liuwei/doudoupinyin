/**
 * 主页布局：把 ActionPanel / Editor / Preview / History / PdfImport / DualHelp
 * 按「上 → 下」的认知顺序串起来：
 *
 *   1. 标题（让用户一眼知道在哪）
 *   2. HistoryPanel（载入旧稿是最常见的入口）
 *   3. ActionPanel（核心操作，首屏可见）
 *   4. Editor（输入源）
 *   5. PrintSettingsPanel（打印设置）
 *   6. DualHelp（双行模式解释，按需展开）
 *   7. PdfImport（辅助导入，靠 Editor 近）
 *   8. Preview（最终结果，最下方）
 *
  ...
  return (
    <main className="app-shell">
      <header className="hero-band">
        <h1>兜兜拼音</h1>
        <p>给课文、故事和练习稿加上清晰 ruby 拼音，家里打印、课堂备课都能用。</p>
      </header>
